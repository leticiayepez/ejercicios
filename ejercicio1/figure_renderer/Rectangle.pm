...
sub draw {
  ...
  my $rectangle = new GD::Polygon; 
  
  $rectangle->addPt($self->getPoint1->getX, $self->getPoint1->getY); 
  $rectangle->addPt($self->getPoint2->getX, $self->getPoint2->getY);
  $rectangle->addPt($self->getPoint3->getX, $self->getPoint3->getY);
  $rectangle->addPt($self->getPoint4->getX, $self->getPoint4->getY);
  $image->polygon($rectangle, $blue);
  $image->filledPolygon($rectangle, $blue);
